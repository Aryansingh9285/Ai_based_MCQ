...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Footer */}
      <footer className="w-full py-3 bg-gray-100 text-gray-600 text-center text-sm border-t">
        &copy; {new Date().getFullYear()} FANG Quiz App. Made By <span className="text-pink-500">Aryan Singh</span>  <span className="text-blue-500">♥</span> for learners.
      </footer>
    </>
  );
}
