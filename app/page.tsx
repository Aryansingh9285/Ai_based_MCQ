  ...
  return (
    <>
      ...
      <header className="relative w-full py-6 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white shadow-2xl">
        <div className="max-w-5xl mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl sm:text-2xl font-bold tracking-tight animate-pulse">
              FANG Quiz App
            </h1>
          </div>
      ...
      <main className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 px-4 sm:px-6 lg:px-8 overflow-auto">
        ...
        <div className="relative bg-white/90 backdrop-blur-lg rounded-2xl shadow-2xl p-8 max-w-md w-full space-y-6 animate-fade-in">
          {/* Name Input */}
          <div className="relative">
            <label className="flex text-sm sm:text-base font-semibold text-gray-700 mb-2 items-center">
          ...
          <div className="relative">
            <label className="flex text-sm sm:text-base font-semibold text-gray-700 mb-2 items-center">
              <span className="mr-2">🎯</span>Select Your Challenge
            </label>
            <div className="relative">
              <select
                value={domain}
      ...
      {/* Footer */}
      <footer className="relative w-full py-4 bg-gradient-to-r from-gray-800 to-gray-900 text-white text-center text-sm border-t border-gray-700">
        <div className="flex flex-wrap items-center justify-center space-x-2 animate-fade-in">
